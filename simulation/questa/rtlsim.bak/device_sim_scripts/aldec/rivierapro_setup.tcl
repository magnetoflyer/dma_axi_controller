...
# ACDS 25.1 129 win32 2025.05.23.16:16:31
# ----------------------------------------
...
# ----------------------------------------
# If  is one of several IP cores in your
...
alias dev_com {
  ...
  if { $PRECOMP_DEVICE_LIB_FILE eq "" } {
    ...
    eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_SIM_LIB_DIR/cyclone10gx_atoms.v"                   -work cyclone10gx_ver     
    eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_SIM_LIB_DIR/aldec/cyclone10gx_atoms_ncrypt.v"      -work cyclone10gx_ver     
    eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_SIM_LIB_DIR/aldec/cyclone10gx_hip_atoms_ncrypt.v"  -work cyclone10gx_hip_ver 
    eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_SIM_LIB_DIR/cyclone10gx_hip_atoms.v"               -work cyclone10gx_hip_ver 
    eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_SIM_LIB_DIR/aldec/cyclone10gx_hssi_atoms_ncrypt.v" -work cyclone10gx_hssi_ver
    eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_SIM_LIB_DIR/cyclone10gx_hssi_atoms.v"              -work cyclone10gx_hssi_ver
  }
