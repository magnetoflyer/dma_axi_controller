...
alias dev_com {
  ...
  if [ check_precomp_device $PRECOMP_DEVICE_LIB_FILE $FORCE_MODELSIM_AE_SELECTION ] {
    eval  qrun -compile -noautoorder -parallel -outdir ./libraries -vlog.options $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS -end \
     ...
     -makelib cyclone10gx_ver "$QUARTUS_SIM_LIB_DIR/cyclone10gx_atoms.v" -end \
     -makelib cyclone10gx_ver "$QUARTUS_SIM_LIB_DIR/mentor/cyclone10gx_atoms_ncrypt.v" -end \
     -makelib cyclone10gx_hip_ver "$QUARTUS_SIM_LIB_DIR/mentor/cyclone10gx_hip_atoms_ncrypt.v" -end \
     -makelib cyclone10gx_hip_ver "$QUARTUS_SIM_LIB_DIR/cyclone10gx_hip_atoms.v" -end \
     -makelib cyclone10gx_hssi_ver "$QUARTUS_SIM_LIB_DIR/mentor/cyclone10gx_hssi_atoms_ncrypt.v" -end \
     -makelib cyclone10gx_hssi_ver "$QUARTUS_SIM_LIB_DIR/cyclone10gx_hssi_atoms.v" -end \
...
alias com {
  ...
  set common_design_files [dict values [get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
